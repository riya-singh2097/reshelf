export const statesNDistricts= [
  ...
  { state: 'Chandigarh (UT)', code: 'CH', districts: [ 'Chandigarh' ] },
  {
    state: 'Chhattisgarh',
    code: 'CG',
    districts: [
...
//   const combinedStatesData = districts.map((x) => {
//   // Use .find() to get the specific sub-array where the name matches
//   const stateMatch = states.find((s) => 
//     x.state.toLowerCase().includes(s[0].toLowerCase()) || 
//     s[0].toLowerCase().includes(x.state.toLowerCase())
//   );

//   // Return a new object containing the name, the code (s[1]), and the districts
//   return {
//     state: x.state,
//     code: stateMatch ? stateMatch[1] : "N/A", // returns s[1] if found
